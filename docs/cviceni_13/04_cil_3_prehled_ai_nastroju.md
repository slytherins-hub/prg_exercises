...
| **Gemini CLI** | **zdarma** s Google účtem (60 req/min, **1 000 req/den**); Google AI Pro/Ultra na vyšší limity | velké refaktoringy díky **1M kontextu**, free volba pro studenty bez předplatného |
