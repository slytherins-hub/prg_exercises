...
Konkrétní zadání doplníme před vypsáním úkolu.

---

### GitHub Classroom (co to je?)
...
2. **Není připravené prostředí pro Python**
...
3. **Zapomněl(a) jsi `git add` před commitem**
