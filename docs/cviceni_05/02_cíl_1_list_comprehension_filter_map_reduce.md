...
V tomhle cíli se zaměříme jen na **list comprehension**.

### Proč je list comprehension důležitý?

1. Je stručný, ale pořád čitelný.
2. Snižuje množství opakovaného kódu (`for` + `append`).
3. U jednoduchých transformací a filtrací bývá často i rychlejší.
...
Ukázka 1: formátování report řádků
...
**📝 ÚKOL: Kontrola objednávek přes list comprehension**
...
3. Pomocí list comprehension vytvoř seznam report řádků:
