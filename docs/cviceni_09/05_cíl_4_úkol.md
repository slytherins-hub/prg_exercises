...
Vytvoř nový notebook `cviceni_09_analyza.ipynb`. Na začátek vlož funkci `generate_patient_data()` a vygeneruj data. Pak řeš postupně:
...
- `cviceni_09_numpy.ipynb` – úkoly z cíle 2 a 3,
- `cviceni_09_analyza.ipynb` – úkoly z cíle 4.
