...
### 2.2 Testovací data: generátor náhodných čísel

Před samotnou implementací si připrav způsob, jak vyrobit testovací seznam. Ručně psát pokaždé jiné hodnoty je otrava — Python má přímo modul `random`, kterým si vygeneruješ libovolně dlouhý seznam čísel v zadaném rozsahu.
...
### 2.3 Úkol: implementace `bubble_sort()`

**📝 ÚKOL: Bubble Sort**

1. Vytvoř modul `sorting.py` a v něm funkci `bubble_sort()`.
...
4. Do stejného souboru zkopíruj funkci `random_numbers()` z předchozí sekce.
