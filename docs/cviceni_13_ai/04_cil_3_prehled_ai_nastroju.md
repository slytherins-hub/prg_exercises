...
| **Antigravity CLI** (Google, nástupce Gemini CLI) | **zdarma** s Google účtem; Google AI Pro/Ultra na vyšší limity | velké refaktoringy díky **1M kontextu**, free volba pro studenty bez předplatného |
