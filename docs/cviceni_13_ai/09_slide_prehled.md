...
<div class="slide" markdown="0">
  ...
  <div class="tool-grid">
    ...
    <div class="tool-card">
      ...
      <ul class="tool-list">
        ...
        <li><img src="../ai_logos/google_antigravity_wordmark.svg" alt="Google Antigravity"><span class="tool-suffix">CLI</span></li>
      </ul>
  ...
  <p class="slide-footer">Algoritmizace a programování · Cvičení 13</p>
</div>
